...
const Footer = () => {
  return (
    <div className="bg-black">
      <footer className="footer bg-black p-10 text-white container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Newsletter Section */}
          <form>
            <h6 className="text-lg font-bold mb-4 font-montserrat">
            ...
            <fieldset className="form-control w-full max-w-xs">
              ...
              <div className="flex space-y-2 flex-col font-inter">
                ...
                />
                <button className="btn btn-white text-[#222222]">
                  Subscribe
                </button>
              </div>
            </fieldset>
      ...
      <div className="container mx-auto bg-black flex flex-col md:flex-row justify-between">
        <p className="text-white font-inter opacity-[50%]">© 2024 Valuetainment Store. All rights reserved.</p>
        <img className="w-[100px] sm:w-auto" src={card} alt="" />
      </div>
    </div>
  );
};
